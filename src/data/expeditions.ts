...
export const expeditions: Expedition[] = [
  ...
  },
  {
    ...
    difficulty_level: "hard",
    short_description: "9 days climbing Kilimanjaro via the Lemosho route, from rainforest to the 5,895m summit of Uhuru Peak.",
  ...
  },
  {
    ...
    intensity_type: "altitude",
    difficulty_level: "hard",
    short_description: "14 days around the Annapurna massif, ending in the crossing of the Thorong La pass at 5,416m.",
  ...
  },
  {
    ...
    intensity_type: "altitude",
    difficulty_level: "hard",
    short_description: "12 days: acclimatization in Cusco, a high-altitude trek and bivouac around Ausangate above 5,000m, then Machu Picchu.",
    long_description: "12-day expedition built around Ausangate, the sacred mountain of the Cusco region: proper acclimatization in the Sacred Valley, then days of trekking and bivouac around the glaciated Ausangate massif, past the rainbow-striped slopes of Vinicunca and turquoise high-altitude lakes above 5,000m, before finishing at Machu Picchu — a far more physical, far less crowded way into the Andes than a standard Peru circuit.",
    status: "open",
    expedition_status: "upcoming",
    itinerary: [
      { day_number: 1, title: "Arrival Cusco", description: "Transfer and rest at altitude, briefing." },
      { day_number: 2, title: "Sacred Valley Acclimatization", description: "Pisac and Ollantaytambo ruins, gentle walking at altitude." },
      { day_number: 3, title: "Cusco Acclimatization Hike", description: "Half-day hike above the city, final gear check." },
      { day_number: 4, title: "Trailhead to Upis", description: "Drive to the trailhead, first camp at the foot of Ausangate with hot springs nearby." },
      { day_number: 5, title: "Upis to Ausangatecocha", description: "Crossing the first high pass, glacier views open up, lakeside camp." },
      ...
      { day_number: 7, title: "Ausangatecocha to Jampa", description: "Second high pass above 5,000m, descent into a remote valley." },
      { day_number: 8, title: "Jampa to Pacchanta", description: "Final pass of the circuit, descent to hot springs at trail's end." },
      { day_number: 9, title: "Return to Cusco", description: "Drive back, rest and recovery day." },
  ...
  },
  {
    ...
    difficulty_level: "hard",
    short_description: "13 days across Torres del Paine and El Chaltén, treks, glaciers and Patagonian weather at the end of the world.",
    long_description: "13-day expedition across the two great trekking grounds of Patagonia: the granite towers and glaciers of Torres del Paine in Chile, and the jagged spires around El Chaltén in Argentina, on foot beneath Fitz Roy. Long days walking, camps exposed to real Patagonian wind and weather, and landscapes that feel genuinely like the end of the world — the prestige piece of the catalog, and the one that makes people believe the rest is possible.",
    status: "open",
    expedition_status: "upcoming",
    itinerary: [
      { day_number: 1, title: "Arrival Punta Arenas", description: "Transfer north, first views of the steppe, briefing." },
      { day_number: 2, title: "Into Torres del Paine", description: "Drive into the park, first camp beneath the towers." },
      { day_number: 3, title: "Base of the Towers", description: "Early trek to the Mirador Base Las Torres, granite spires at sunrise." },
      { day_number: 4, title: "French Valley", description: "Full trek day through the French Valley, hanging glaciers on both sides." },
      { day_number: 5, title: "Grey Glacier", description: "Walk to the shore of Lago Grey, icebergs calved from the Southern Patagonian Ice Field." },
      { day_number: 6, title: "Crossing to Argentina", description: "Border crossing and long drive toward El Chaltén." },
      { day_number: 7, title: "Arrival El Chaltén", description: "Rest and acclimatization to the wind, gear check for the next stage." },
      { day_number: 8, title: "Laguna de los Tres", description: "Full-day trek beneath Fitz Roy to the glacial lake at its base." },
      { day_number: 9, title: "Cerro Torre Valley", description: "Second trek day toward the needle spire of Cerro Torre." },
      { day_number: 10, title: "Weather Day", description: "A reserve day built into the itinerary for Patagonian weather, used for a shorter valley walk or rest." },
      { day_number: 11, title: "Lago del Desierto", description: "Boat and trail along a remote glacial lake near the Chilean border." },
      { day_number: 12, title: "Return to El Calafate", description: "Drive along the steppe, visit to the Perito Moreno Glacier front." },
  ...
  },
  {
    ...
    short_description: "12 days trekking through the Tian Shan on foot and horseback, high passes, pack horses, tents and yurts.",
    long_description: "12-day trekking expedition through the Central Tian Shan, the \"Mountains of Heaven\": high alpine passes crossed on foot, pack horses carrying the loads, nights in tents and shepherd yurts, and some of the best sensation-per-effort in mountain trekking anywhere — remote enough to feel like a real expedition, without requiring technical climbing.",
    status: "open",
    expedition_status: "upcoming",
    itinerary: [
      ...
      { day_number: 3, title: "First Pass", description: "Trekking day to the first high pass, pack horses carrying the heavy loads." },
      { day_number: 4, title: "Jyrgalan Valley", description: "Long valley walk, glacial streams and alpine meadows." },
      { day_number: 5, title: "Second Pass", description: "A harder crossing above 3,800m, camp on the far side." },
      { day_number: 6, title: "Song-Köl Approach", description: "Descent toward the high alpine lake, first yurt camp with a herding family." },
      { day_number: 7, title: "Song-Köl Lake", description: "Rest day at the lake, horseback riding across the surrounding pastures." },
      { day_number: 8, title: "Third Pass", description: "Final high crossing of the trek, views back over the whole range." },
      { day_number: 9, title: "Descent to the Valley", description: "Long descent day, first trees in a week." },
  ...
  },
  {
    ...
    difficulty_level: "hard",
    short_description: "8 days on snowshoes and pulka north of the Arctic Circle: real cold, wild cabins and isolated nights, no huskies, no Santa.",
    long_description: "8-day winter mini-raid across Finnish Lapland, north of the 66th parallel: snowshoes and pulka sled hauling your own gear across frozen lakes and forest, wild cabin nights and stretches of genuine isolation in temperatures that can drop past -25°C. Deliberately not a husky-and-Santa tourist package — this is a real, physically demanding taste of what it means to move and sleep in the Arctic, ending with a sauna and a lodge night to thaw out.",
    status: "open",
    expedition_status: "upcoming",
    itinerary: [
      { day_number: 1, title: "Arrival Ivalo", description: "Cold-weather gear fitting, briefing on Arctic travel and safety." },
      { day_number: 2, title: "First Steps on Snow", description: "Snowshoe and pulka technique on short terrain before the real distances begin." },
      { day_number: 3, title: "Onto the Frozen Lakes", description: "First full day hauling the pulka across frozen lake systems." },
      { day_number: 4, title: "Deep Forest", description: "Crossing boreal forest, wild cabin for the night, wood stove and northern lights watch." },
      { day_number: 5, title: "Open Fell", description: "A day on exposed fell terrain, real cold, real wind, real isolation." },
      { day_number: 6, title: "Second Wild Cabin", description: "Long haul to a remote cabin, no road access, total quiet." },
      { day_number: 7, title: "Return Crossing", description: "Final trekking day back toward the trailhead." },
  ...
  },
  {
    ...
    difficulty_level: "hard",
    short_description: "8 days crossing Iceland's Central Highlands on foot: mountain huts and bivouacs, black volcanic terrain and river crossings.",
    long_description: "8-day trek across Iceland's Central Highlands, entirely on foot: black volcanic sand, obsidian lava fields, geothermal valleys and glacial river crossings, sleeping in mountain huts and bivouacs with no road ever in sight. No road-trip, no ring-road driving — this is the Highlands the way they're meant to be seen, moving through one of the most alien landscapes in Europe at walking pace.",
    status: "open",
    expedition_status: "upcoming",
    itinerary: [
      { day_number: 1, title: "Arrival Reykjavík", description: "Gear check, briefing, transfer toward the highland edge." },
      { day_number: 2, title: "Landmannalaugar", description: "Arrival at the trailhead, geothermal valley of rhyolite mountains, first river crossing practice." },
      { day_number: 3, title: "Into the Black Desert", description: "Crossing obsidian lava fields toward Hrafntinnusker, first mountain hut night." },
      { day_number: 4, title: "Green Valleys", description: "Descent into Álftavatn's green valleys after the black desert, second river crossing." },
      { day_number: 5, title: "Emstrur Wilderness", description: "Crossing a stark volcanic desert between two glaciers, isolated hut camp." },
      { day_number: 6, title: "Þórsmörk", description: "Descent into the forested valley of Þórsmörk, framed by three glaciers." },
      { day_number: 7, title: "Fimmvörðuháls Pass", description: "Full-day crossing between the Eyjafjallajökull and Mýrdalsjökull glaciers, past young lava fields from the 2010 eruption." },
